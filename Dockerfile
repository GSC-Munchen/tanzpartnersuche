...
# === Adapted from typo3 version 10.4.21 to 10.4.18 by Dominik Fickenwirth, Dec 02, 2021 ===
...
#    echo "bfd691eecc88908b2937ae793d658029c45f36d490c16626fee06440c2ae6d5d download.tar.gz" > download.tar.gz.sum && \
    wget -O download.tar.gz https://get.typo3.org/10.4.18 && \
    echo "93d2389e21be17ec6ace908d804af1211024c82847ed28d957c4e3659ca3417f download.tar.gz" > download.tar.gz.sum && \
