...
(static function() {
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::configurePlugin(
        ...
        'Tanzpartnersuche',
        [
            \GSC\Tanzpartnersuche\Controller\TanzpartnersucheController::class => 'index, show, new, create, edit, update, delete, deleted, verify, search, help, detail, login, logout, status, mail, loggedin, loginMenu'
        ],
        // non-cacheable actions
        [
            \GSC\Tanzpartnersuche\Controller\TanzpartnersucheController::class => 'new, create, update, delete, deleted, verify, status, detail, search, mail, login, loggedin, loginMenu, logout, edit'
        ]
    );
